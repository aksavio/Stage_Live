...
class Title:
    ...
    """
    def __init__(self, text, SCREEN_WIDTH, SCREEN_HEIGHT, font_size=65, font_color=(255, 255, 255), font_name=None):
        """
        ...
        self.font = pygame.font.SysFont("Helvetica_neue", font_size)
